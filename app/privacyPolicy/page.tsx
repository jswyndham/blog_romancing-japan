	...
	return (
		<section className="relative h-full flex flex-col items-center justify-center overflow-x-hidden">
			...
			<article className="absolute top-0 w-full bg-slate-700 py-4 flex justify-center text-white text-3xl font-bold">
				<h1>Romancing Japan | Privacy Policy</h1>
			</article>
			...
			<article className="mt-28 mb-24 flex flex-col items-center justify-center px-3 w-[90%] md:w-[75%] xl:max-w-4xl text-justify">
				...
				<div className="mb-8 mt-2">
					...
					<div className="text-xl font-heading">
						<p>
							At Romancing Japan, accessible from
							www.romancing-japan.com, one of our main priorities
							is the privacy of our visitors. This Privacy Policy
							document contains types of information that is
							collected and recorded by Romancing Japan and how we
							use it.
						</p>
						...
						<p>
							...
							and/or collect in Romancing Japan. This policy is
				...
				<div className="mb-12 mt-2 text-xl font-heading">
					...
					<p className="my-2">
						Romancing Japan follows a standard procedure of using
					...
					<p className="mt-2 mb-5">
						...
						each of the advertising partners of Romancing Japan.
					</p>
					...
					<p className="my-5">
						...
						on Romancing Japan, which are sent directly to
						...
						and/or to personalize the advertising content that you
						see on websites that you visit.
					</p>

					<p className="my-2">
						Note that Romancing Japan has no access to or control
				...
				<div className="mb-12 mt-2 text-xl font-heading">
					...
					<p className="my-2">
						Romancing Japan&apos;s Privacy Policy does not apply to
				...
				<div className="mb-12 mt-2 text-xl font-heading">
					...
					<p className="my-5">
						Romancing Japan does not knowingly collect any Personal
