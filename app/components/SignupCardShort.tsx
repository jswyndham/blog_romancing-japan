        ...
        <article className="">
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <div className="card-actions relative">
                ...
                <input
                  ...
                  className="w-full flex justify-start py-2 pl-8 ml-4 mr-2 rounded-md outline outline-offset-2 outline-slate-400 focus:outline-green-400"
                  required
                  ref={firstNameRef}
            ...
            <div className="my-4 py-3 mx-2">
              <button
                className="w-full h-full py-1 bg-red-400 outline outline-offset-2 outline-slate-300 rounded-xl text-white font-bold active:bg-green-500 active:text-base-100 hover:bg-red-500 hover:outline-slate-400 transition-all duration-300"
                type="submit"
              >
                Subscribe
              </button>
