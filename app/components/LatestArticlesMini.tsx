  ...
  return (await posts).map(async (post: any) => {
    return (
      <Link key={post._id} href={`/posts/${post.slug}`}>
        ...
        <div className="card rounded-none w-fit h-fit mx-2 my-4 hover:shadow-lg hover:shadow-slate-200 hover:drop-shadow hover:transition-all duration-300 group">
          <figure className="">
            <Image
          ...
          <div className="card-body p-4 my-2 h-fit">
            <div className="flex items-center h-24 pl-3 pr-2 py-2 border-l-2 border-red-600 xl:h-28">
