...
export default async function ArticleCardTwo() {
  ...
  return (
    <Link key={post._id} href={`/posts/${post.slug}`}>
      <div className="flex flex-col card rounded-none w-fit h-fit mx-2 my-1 hover:shadow-lg hover:shadow-slate-200 hover:drop-shadow  hover:bg-base-100 hover:transition-all duration-300 md:h-96 md:w-full md:my-2 md:mx-0 md:card-side">
