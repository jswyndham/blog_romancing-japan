...
export default async function ArticleCardTwo() {
  ...
  return (
    <Link key={post._id} href={`/posts/${post.slug}`}>
      <div className="flex flex-col m-5 bg-base-300 shadow-lg shadow-slate-400 rounded-lg md:bg-base-100 lg:card-side md:card md:w-96 hover:shadow-xl hover:shadow-slate-500 hover:transition-all duration-300">
