        ...
        <div className="bg-slate-300 w-52 px-4 2xl:px-4 pt-16 pb-6 mx-2 text-justify font-playfair_display whitespace-pre-line">
          ...
          <div>
            <p className="text-lg">
              ...
              other hand, am from Melbourne, Australia. However, I've made Kyoto
              my home. Together we've built the Romancing Japan site so we can
              share our passion for Japanese culture, lifestyle, travel, and
              cooking.
            </p>
          </div>
        </div>
