			...
			<div className="flex flex-col items-end justify-end px-4">
				...
				<div className="p-6">
					<p className="text-lg font-sans">
						Hi everyone! I&apos;m James and this is my amazing wife,
						Akari. We live in Kyoto, Japan, where we raise two
						beautiful children. Akari is a native to Kyoto and has
						lived here her whole life. I, on the other hand, am from
						Melbourne, Australia. I started coming to Japan as a
						teenager and have over 30 years of experience with
						Japanese culture. We&apos;ve made Kyoto our home and
						together we&apos;ve built the Romancing Japan site so we
						can share our passion for Japanese culture, lifestyle,
						and travel.
					</p>
				</div>
			</div>
