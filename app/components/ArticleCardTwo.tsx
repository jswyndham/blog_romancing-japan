...
export default async function ArticleCardTwo() {
  ...
  return (
    <Link key={post._id} href={`/posts/${post.slug}`}>
      <div className="flex flex-col card rounded-none w-fit h-fit mx-4 my-4 hover:shadow-lg hover:shadow-slate-200 hover:drop-shadow  hover:bg-base-100 hover:transition-all duration-300 group md:bg-base-200 md:h-full md:w-full md:my-2 md:ml-0 md:mr-3 md:mb-3 md:card-side">
