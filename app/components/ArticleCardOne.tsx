...
export default async function ArticleCardOne() {
  ...
  return (
    <Link key={post._id} href={`/posts/${post.slug}`}>
      ...
      <div className="flex flex-col m-5 bg-base-100 shadow-lg shadow-slate-500 rounded-lg md:rounded-md md:bg-base-300 md:flex-row md:my-4 md:mx-0 md:w-full md:h-full md:card lg:card-side hover:shadow-xl hover:shadow-slate-600 hover:drop-shadow hover:transition-all duration-300 group">
