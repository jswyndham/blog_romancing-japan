          ...
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto pt-[20px] w-[600px] px-16 pb-16">
            ...
            <Section>
              ...
              <Text className="text-lg">
                ...
                you have signed up with us, we will send you bi-monthly messages
                to keep you up-to-date with our latest articles.
              </Text>
            </Section>
            <Section>
              <Text className="text-lg">
                We write and post regular content to our site to help people
                stay informed about the topics their interested in regarding
                Japan. We will be documenting our journey and documenting the
